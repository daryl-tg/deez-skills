...
| `principle-test-behavior-not-implementation` | principle | claude, codex | Apply when writing, changing, or keeping a test. Call the code the way its users do and assert the observed result against a literal value. A test that would s… |
