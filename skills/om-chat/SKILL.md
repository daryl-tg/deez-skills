---
name: om-chat
description: "Read, search, summarize, draft, and post in OM Chat rooms, channels, and DMs as a governed guest, through the OpenMarket MCP rooms tools. Use when the task context is an OM Chat link."
---
